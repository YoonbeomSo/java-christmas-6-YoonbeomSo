...
class WeekdayEventTest {
    ...
    @DisplayName("이벤트 기간에 해당하지 않으면 false 를 리턴 해야 한다.")
    @Test
    public void 이벤트_기간_테스트() {
        Orders validOrder = new Orders(orderMenuList, LocalDate.of(2023, 12, 26));
    ...
    @DisplayName("평일에는 디저트 메뉴를 메뉴 1개당 2,023원 할인 한다")
    @Test
    public void 이벤트_혜택_금액_테스트() {
        Orders orderDuringEvent = new Orders(orderMenuList, LocalDate.of(2023, 12, 26));
